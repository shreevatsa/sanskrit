...
data_vrttaratnakara = [
    ...
    # ('nārācaka', 'GGLGLGLG'), # nārācikā in big list
    ('halamukhī', 'GLGLLLLLG'),
    ...
    ('mālatī', 'LLLLGLLGLGLG'),
    # ('pañcacāmara', 'LGLGLGLGLGLG'), # shouldn't this have more syllables?
    # ('tāmarasa', 'LLLLGLLGLLGG'), # in DD list too
    ...
    # ('induvadanā', 'GLLLGLLLGLLLGG'), # indravadanā in DD
    ...
    ('meghavisphurjita', 'LGGGGG — LLLLLG — GLGGLGG'),  # meghavisphūrjitā in DD
    ...
    ('vegavatī1', ['LLGLLGLLGLLGG', 'GLLGLLGLLGG']),   # different in DD
    ('bhadravirāṭ', ['GGLLGLGLGG', 'GGGLLGLGLG']),  # different in DD
    ...
    ('kalikā', ['LLLLLLLLLLGG',
                ...
                'LLLLLLLLLLLLLGG',
                'LLLLLLLLLLLLLLLLLLGG']),
    # TODO(shreevatsa): These two conflict with each other.
    # ('lavalī', ['LLLLLLLLLLGG',
    #             'LLLLLLLLLLLLLLGG',
    #             'LLLLLLGG',
    #             'LLLLLLLLLLLLLLLLLLGG']),
    ...
    #                 'GLGLLLGLLG',
    #                 'LLGLGLLLGLGLG']),
    # ('lalita', ['LLGLGLLLGL',  # better in DD
    #             'LLLLLGLGLG',
    #             'LLLLLLLLGLLG',
    #             'LLGLGLLLGLGLG']),
    # ('upasthitapracupita', ['GGGLLGLGLGLLGG',  # better name in DD
    #                         'LLGLLLLGLGLGG',
    #                         'LLLLLLLLG',
    #                         'LLLLLLLLLLGLLGG']),
    # TODO(shreevatsa): These two conflict with each other.
